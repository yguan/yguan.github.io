<div class="content">
    ...
    <div class="cv">
        <div class="header block">
            ...
            <span class="contact">
                Bellevue, WA <br />
                <a href="http://www.linkedin.com/in/yongguan" target="_blank">linkedin.com/in/yongguan</a>
            </span>
        </div>
        <div class="sites">
            <a href="http://yguan.github.io" target="_blank">
                <span class="site portfolio">
                    <span class="spacer"></span>
                    portfolio: yguan.github.io
                </span>
            </a>
            <a href="https://github.com/yguan" target="_blank">
                <span class="site projects">
                    <span class="spacer"></span>
                    projects: github.com/yguan
                </span>
            </a>
        </div>
        <div class="objective block">
        Open to exciting opportunity as a full stack developer, to work on browser-based front-end UI and back-end services (including databases). Prefer to work with JavaScript, CSS, HTML, C#, Python, Node.js, SQL, and NoSQL. Would be delighted to work on front-end visualization and machine learning.
        </div>
        <div class="main block">
            <div class="left">
                <div class="experience">
                    ...
                    Implement features for a web-based e-discovery application that utilizes machine learning for document discovery.

                    <p>
                        02/2011 - 01/2013<br />
                        <b>Software Engineer II</b><br />
                        <a href="http://www.daptiv.com" target="_blank">Daptiv</a> (Seattle, WA)<br />
                        Implemented features for a web-based project portfolio management application.
                    </p>
                    ...
                    <p>
                        ...
                        Implemented features for a web-based high school e&#8209;learning application.
                    </p>
