...
<section>
    ...
    <h3>A collection of learning materials for Event-driven Architecture</h3>
    <p class="center">
...
<section>
    ...
    <section>
        ...
        <p class="note">
            This is the best talk I could find about the problems with SOA and how to solve them.
        </p>
    </section>
    ...
    <section>
        ...
        <p class="note">
            This talk comes with practical examples.
        </p>
    </section>
...
<section>
    ...
    <section>
        ...
        <ul class="indent">
            <li>It’s not (only) the size that matters, it’s (also) how you use them
                <ul>
                    <li><a href="http://www.tigerteam.dk/2014/micro-services-its-not-only-the-size-that-matters-its-also-how-you-use-them-part-1/" target="_blank">Pat 1</a></li>
                    <li><a href="http://www.tigerteam.dk/2014/micro-services-its-not-only-the-size-that-matters-its-also-how-you-use-them-part-2/" target="_blank">Pat 2</a></li>
                    <li><a href="http://www.tigerteam.dk/2014/microservices-its-not-only-the-size-that-matters-its-also-how-you-use-them-part-3/" target="_blank">Pat 3</a></li>
                    <li><a href="http://www.tigerteam.dk/2014/microservices-its-not-only-the-size-that-matters-its-also-how-you-use-them-part-4/" target="_blank">Pat 4</a></li>
                </ul>
            </li>
            <li><a href="http://www.infoq.com/articles/microservices-intro" target="_blank">Decomposing Applications for Deployability and Scalability</a></li>

            <li><a href="http://www.infoq.com/news/2014/05/microservices" target="_blank">The Strengths and Weaknesses of Microservices</a></li>
    ...
    <section>
        ...
        <p class="note">
            This talks is about how Netflix implemented microservices.
        </p>
    </section>
</section>
